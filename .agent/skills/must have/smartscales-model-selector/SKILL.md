...
Esta skill es la **Autoridad Suprema de Gobernanza** . Controla el flujo de aprobación y la selección de infraestructura de IA para todas las sesiones.

Utiliza esta skill para evaluar y recomendar el modelo de IA y el modo de planificación más óptimo antes de iniciar cualquier tarea en el proyecto. Esta guía está actualizada al estado del arte de 2026.
...
| **Gemini 3 Pro (Hi)** | 🟡 6 dias | Deep Context / Repo-wide | Multi-file Refactors / Planning |
| **Gemini Flash** | 🟢 Ninguna | Latencia / UI / Iteración | Everyday Coding / UI Tweaks |

## ⚖️ Regla de Economía de Modelos
- **No quemes un Claude** por una tarea que Gemini Pro (6 dias) puede resolver.
