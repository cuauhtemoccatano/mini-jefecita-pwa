...
export function loadState() {
    try {
        userData = JSON.parse(localStorage.getItem('user_settings') || '{"name": "Viajero", "jadeName": "Jade", "auraColor": "#00C4B4", "auraPreset": "jade", "brain": "AUTO", "streak": 0, "remindersCount": 0, "chatHistory": [], "onboarded": false}');
        ...
        userData = {"name": "Viajero", "jadeName": "Jade", "auraColor": "#00C4B4", "auraPreset": "jade", "brain": "AUTO", "streak": 0, "remindersCount": 0, "chatHistory": [], "onboarded": false};
